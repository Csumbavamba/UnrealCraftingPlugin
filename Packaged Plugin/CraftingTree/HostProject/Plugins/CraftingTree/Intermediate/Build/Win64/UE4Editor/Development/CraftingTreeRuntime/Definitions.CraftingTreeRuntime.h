#undef CRAFTINGTREERUNTIME_API
#undef CRAFTINGTREERUNTIME_VTABLE
#define IS_PROGRAM 0
#define UE_EDITOR 1
...
#define CRAFTINGTREERUNTIME_VTABLE DLLEXPORT_VTABLE
#define CRAFTINGTREERUNTIME_API DLLEXPORT
